...
extern __attribute__ ((aligned(4))) UINT8 PD_Rx_Buf[ 64 ];
extern __attribute__ ((aligned(4))) UINT8 PD_Tx_Buf[ 64 ];
...
extern void PD_Analyzer_Notify_Attach( UINT8 cc );
extern void PD_Analyzer_Notify_Detach( void );
extern UINT8 PD_Detect_Analyzer( UINT8 connected, UINT8 active_cc );
